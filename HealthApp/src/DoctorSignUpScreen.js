...
import {Text, View, StyleSheet, Dimensions,
    ...
    KeyboardAvoidingView,ToastAndroid, ScrollView
} from 'react-native';
...
const DoctorSignUpScreen = () => {
    ...
    const SignUpDoctor = () => {
        if (password !== passwordConfirm){
            ...
            axios.post(`${BaseURL}/doctor/signup`,{fullName, phoneNumber,speciality, email, password})
                .then((res) => {
    ...
    return (
        <ScrollView>
            ...
            >
                ...
                <Text style={styles.headerTitle}>Doctor Sign Up</Text>
                ...
                <View style={styles.inputViewContainer}>
                    <Text style={styles.inputViewLabel}>Area of Speciality</Text>
                    <TextInput
                        style={styles.inputTextInput}
                        placeholder='Enter your email address'
                ...
                <TouchableOpacity style={styles.loginbutton} onPress={SignUpDoctor}>
